...
#define cols 3 //总列数
#define linColor 0xffffff //线条颜色
#define linWidth 2 //线条宽度
//当前屏幕宽度
...
@interface HMGesturesUnlockView ()
...
@implementation HMGesturesUnlockView
...
- (void)setup {
    ...
    for (int i = 0; i < 9; i++) {
        ...
        [btn setImage:[UIImage imageNamed:@"gesture_node_normal"] forState:UIControlStateNormal];//非选中状态的图片
        [btn setImage:[UIImage imageNamed:@"gesture_node_highlighted"] forState:UIControlStateSelected];//选中状态的图片
        btn.tag = 1000+i;
        [self addSubview:btn];
    }
